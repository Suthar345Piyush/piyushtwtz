        ...
        <motion.section initial={{opacity : 0 , y : 20}} animate={{opacity : 1 , y : 0}} transition={{duration : 0.5}} className='mb-16'>
         ...
         <div className='flex flex-col md:flex-row items-center gap-8 md:gap-12'>
            ...
            <motion.div initial={{opacity : 0 , scale : 0.8}} animate={{opacity : 1 , scale : 1}} transition={{duration : 0.5 , delay : 0.2}} className='relative'>
               ...
               <div className='w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden ring-4 ring-gray-800 dark:ring-gray-700 shadow-xl bg-linear-to-br from blue-500 to purple-600'>
           ...
           <p className='text-black text-lg'>been here for 20 years/.</p>
